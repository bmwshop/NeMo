...
class NLPDDPStrategy(DDPStrategy):
    ...
    def __init__(
        ...
        **kwargs: Union[Any, Dict[str, Any]],
        ...
        logging.info(f'self.torch_dist_ckpt: {self.torch_dist_ckpt}')
    ...
    def save_checkpoint(
        ...
        if (
            ...
            logging.info(f'dist_checkpointing strategy: {sharded_strategy}')
        ...
        if (app_state.model_parallel_size is not None and app_state.model_parallel_size > 1) or dist_ckpt:
            ...
            if dist_ckpt:
                ...
                if fs.isdir(dist_ckpt_dir) and dist_checkpointing.check_is_distributed_checkpoint(dist_ckpt_dir):
                    ...
                    logging.info(f'dist_checkpointing.save strategy: {sharded_strategy}')
                    dist_checkpointing.save(
